...
def menu(control):
    if control == 0:
        ...
        if utils.supply_available():
            ...
            utils.log(
                0, "Voltage set to " + str(voltage) + " Volts on Supply #" + str(supply_index)
            )
        else:
            utils.log(
                3,
        ...
        if utils.supply_available():
            ...
            utils.log(
                0, "Amperage set to " + str(current) + " Amps on Supply #" + str(supply_index)
            )
        else:
            utils.log(
                3,
        ...
        utils.log(
            0, "Sensor 1:\t" + str(cage_temp_1) + "°C\t" + str(utils.c_to_f(cage_temp_1) + "°F")
        )
        utils.log(
            0, "Sensor 2:\t" + str(cage_temp_2) + "°C\t" + str(utils.c_to_f(cage_temp_2) + "°F")
        )
    elif control == 6:
        ...
        if utils.supply_available():
            ...
            desired_x = float(
                input("What is the ideal strength of the x component? (microTeslas)\n")
            )
            desired_y = float(
                input("What is the ideal strength of the y component? (microTeslas)\n")
            )
            desired_z = float(
                input("What is the ideal strength of the z component? (microTeslas)\n")
            )
