...
def temperature():
    ...
    # Temp MSB, TEMP LSB
    data1 = bus.read_i2c_block_data(0x18, 0x05, 2)

    # Convert the data to 13-bits
    ctemp1 = ((data1[0] & 0x1F) * 256) + data1[1]
    ctemp1 = checksize(ctemp1, 4095, 8192)
    ctemp1 = ctemp1 * 0.0625
    ftemp1 = ctemp1 * 1.8 + 32

    # Output data to screen
    print "Sensor 1"
    print "Temperature in Celsius is    : %.2f C" %ctemp1
    print "Temperature in Fahrenheit is : %.2f F" %ftemp1
    ...
    data2 = bus.read_i2c_block_data(0x1c, 0x05, 2)

    ctemp2 = ((data2[0] & 0x1F) * 256) + data2[1]
